...
class UserPreferences(private val context: Context) {
    ...
    private object PreferencesKeys {
        ...
        val APP_LANGUAGE = stringPreferencesKey(SafetyConstants.PREF_KEY_APP_LANGUAGE)
    }

    // App Language
    val appLanguageCodeFlow: Flow<String> = context.dataStore.data.map { prefs ->
        prefs[PreferencesKeys.APP_LANGUAGE] ?: "system"
    }
